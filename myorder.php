                            ...
                            <form action="#">
                               ...
                               <table>
                                        ...
                                        <tbody>
                                            ...
                                            $query=mysqli_query($conn,"select `order`.*,order_status.name as order_status_str from `order`,order_status where `order`.user_id='$user_id' and order_status.id=`order`.order_status order by `order`.id desc");
                                                while($row=mysqli_fetch_assoc($query)){

                                                
                                            ?>
                                            <tr>
                                                <td class="product-add-to-cart"><a href="myorder_details.php?id=<?php echo $row['id'] ?>">Order Details <?php echo $row['id'] ?></a><br/>
                                               <a href="order_pdf.php?id=<?php echo $row['id'] ?>">Print Invoice</a></td>
