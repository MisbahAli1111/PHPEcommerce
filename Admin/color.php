...
<?php
    ...
    if(isset($_GET['type']) && $_GET['type']!='')
    {
        ...
        if($type=='status')
        {
            ...
            $sql="update color_master set status='$status' where id='$id'";
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <h5><a href="add_color.php">Add color</a></h5>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-100">
                            <div class="card shadow mb-5">
                                ...
                                $sql="select * from color_master  order by color desc";
        ...
        if(mysqli_num_rows($query_run)>0)
        {
            while($row=mysqli_fetch_assoc($query_run))
            {
                ...
                <?php
                   ...
                   <?php echo "<span class='update'><a href='update_color.php?id=".$row['id']."'>Update</a> </span>";?>
