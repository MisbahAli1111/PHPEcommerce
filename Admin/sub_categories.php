...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <h5><a href="manage_sub_categories.php">Add Sub Categories</a></h5>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-100">
                            <div class="card shadow mb-5">
                                ...
                                $sql="select categories.categories,sub_categories.* from categories,sub_categories where sub_categories.categories_id=categories.id order by sub_categories desc";    
        ...
        if(mysqli_num_rows($query_run)>0)
        {
            while($row=mysqli_fetch_assoc($query_run))
            {
                ...
                <?php
                   ...
                   <?php echo "<span class='update'><a href='update_sub_categories.php?id=".$row['id']."'>Update</a> </span>";?>
